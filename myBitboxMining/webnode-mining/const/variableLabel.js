module.exports.en = {
    ...
    LABEL_PRODUCT_INCLUDED_MAINTAINCE_FEE: 'Price: included electricity cost.',
    LABEL_PRODUCT_WITHOUT_MAINTAINCE_FEE: 'Price: not included electricity cost.',
    LABEL_MAINTENANCE_FEE: 'Electricity cost: ',
    ...
    TITLE_CUSTOMER_MAINTAINCE_FEE: 'Electricity cost',
    ...
    RC_OUR_SERVICES: 'Our products',

    // react label in customer product page
    RC_UPDATE_PRODUCT: 'Update Product',
    RC_MAINTENANCE_FEE: 'Electrictcity cost(month)',
    RC_CREATE_WALLET_YET: 'If you have not created a wallet address yet. Please click here to create a new wallet address',
