...
//import { language } from '../../../../../const/admin/variableLabel';
                ...
                <div className="col-md-5">
                    <div className="card">
                        <div className="card-header-product login-header">
                            <h4 className="card-title"><strong>{language.en.LABEL_LOGIN_TITLE}</strong></h4>
                        </div>
                        <div className="card-body">
                            ...
                            <form id="loginform" className="col-md-12" role="form" method="POST" onSubmit={this.handleSubmit}>
                                <div className="input-group">
                                    ...
                                    <input id="login-email" type="email" className="form-control" name="email" placeholder={language.en.LABEL_EMAIL} required />
                                    <p className="error-email"></p>
                                </div>

                                <div className="input-group">
                                    <span className="input-group-addon"><i className="glyphicon glyphicon-lock"></i></span>
                                    <input id="login-password" type="password" className="form-control" name="password" placeholder={language.en.LABEL_PASSWORD}
                                        pattern="^(?=.*\d)(?=.*[a-z])(?=.*[@!#$%^&])(?=.*[A-Z]).{8,50}$" required />
                                </div>
                                <div className="form-group">
                                    <p id="error-message"></p>
                                    <div className="col-sm-12 controls">
                                        <button id="btn-login" type="submit" className="btn btn-success">{language.en.LABEL_BUTTON_LOGIN}</button>
                                    </div>
                                </div>
                            </form>
                            <div className="card-footer">
                                <div className="stats">
                                    <a href="#" data-toggle="modal" data-target="#forgot-password">
                                        <span>{language.en.LABEL_BUTTON_FORGOT_PASSWORD}</span>
                                    </a>
                                </div>
                            </div>
                        </div>
