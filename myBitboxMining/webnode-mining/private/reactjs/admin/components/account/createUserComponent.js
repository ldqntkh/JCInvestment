                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            <div className="form-group">
                                                <label className="bmd-label-floating">{showMessage('LABEL_FORM_PHONENUMBER')}</label>
                                                <input id="phone" type="tel" name="phone" className="form-control" maxLength="11" pattern="\(?([0-9]{3})\)?([ .-]?)([0-9]{3})\2([0-9]{5})" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
